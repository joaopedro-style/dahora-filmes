...
/* o ? para garantir que não dê erro caso alguma das propriedades abaixo esteja indefinida (undefined). O 'as strings' no final é para o TS lidar com o valor considerando que é uma string */
